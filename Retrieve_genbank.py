### Script to download Genbank data ###
### This script is an adaptation of Thomas Creedy's script (https://github.com/tjcreedy/biotools/blob/main/retrieve_genbank.py). All credit to him. ###
#Adaptations: fixed problem with script failure when accessions do not have references. The script now includes latitude and longitude data in the metadata where available. The script allows downloads above the NCBI limit#
            ...
            if var in srcfeat.qualifiers.keys():
                ...
                if var == 'db_xref':
                    ...
                    if var == 'country':
                        ...
                        srdata[var] =  val
        if 'references' in sr.annotations:
            srdata['authors'] = fmtaut(sr.annotations['references'][0].authors)
